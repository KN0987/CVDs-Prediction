...
# Load the dataset
heart_data = pd.read_csv('Exploratory Data Analysis\\Models\\heart.csv')
...
joblib.dump(bagged_tree, 'Exploratory Data Analysis\\Models\\bagged_decision_tree_model.pkl')
joblib.dump(log_reg, 'Exploratory Data Analysis\\Models\\logistic_regression_model.pkl')
joblib.dump(scaler, 'Exploratory Data Analysis\\Models\\scaler.pkl')  # Save the scaler as well
